  ...
  return (
    <nav className="w-full h-24 shadow-xl bg-zinc-900">
        <div className="flex justify-between items-center h-full w-full px-4 2xl:px-16">
            ...
            <div onClick={handleNav} className="md:hidden cursor-pointer pl-24 bg-zinc-900 text-white hover:border-w">
                <AiOutlineMenu size={30} />
            </div>
        </div>
        <div className={menuOpen ? "fixed left-0 top-0 w-[65%] sm:hidden h-screen bg-zinc-900 p-10 ease-in duration-500" : "fixed left-[-100%] top-0 p-10 ease-in duration-500 "}>
            <ul>
